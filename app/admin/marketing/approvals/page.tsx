...
import {
  approveAndExecuteMarketingApproval,
...
export default async function MarketingApprovalsPage({ searchParams }: PageProps) {
  ...
  return <AdminPageContainer>
    <AdminPageHeader title={isArabic ? "مركز الاعتمادات" : "Approvals Center"} description={isArabic ? "Approve / Edit / Reject / Approve & Execute / Schedule / Cancel مع سجل قرار واضح." : "Approve / Edit / Reject / Approve & Execute / Schedule / Cancel with a clear decision trail."} />
