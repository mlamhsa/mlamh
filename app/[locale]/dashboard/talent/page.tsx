      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-10 lg:grid-cols-[290px_1fr]">
        <aside className="rounded-[2rem] border border-white/10 bg-white/[0.025] p-5 lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
          ...
          <nav className="mt-6 grid gap-2">
            ...
            <SidebarLink
              icon="📅"
              href={`/${locale}/talent-dashboard/availability`}
            ...
            <SidebarLink
              icon="📊"
              href={`/${locale}/talent-dashboard/insights`}
  ...
  >
    {isRtl ? "تسجيل الخروج" : "Sign Out"}
        ...
        <div>
          ...
          <section className="mb-10 rounded-[2rem] border border-white/10 bg-white/[0.025] p-6">
