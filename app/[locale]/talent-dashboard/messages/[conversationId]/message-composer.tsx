...
const [
  ...
  const quickReplies = isArabic
    ? [
        "شكرًا لتواصلكم.",
        "أنا متاح في الموعد المقترح.",
        "سأرسل نماذج الأعمال المطلوبة.",
        "يسعدني الانتقال إلى الخطوة التالية.",
      ]
    : [
        "Thank you for contacting me.",
        "I am available at the proposed time.",
        "I will send the requested work samples.",
        "I am happy to proceed to the next step.",
      ];
