...
export async function submitTalentProfileReviewAction(
  ...
  if (profileError || !profile) {
    console.error("[submitTalentProfileReviewAction profile]", profileError);
    return {
      success: false,
      message: isArabic ? "تعذر العثور على بيانات الحساب." : "Unable to find your account profile.",
    };
  }
  ...
  if (talentError || !talent) {
    console.error("[submitTalentProfileReviewAction talent]", talentError);
    return {
      success: false,
  ...
  if (profileUpdateError) {
    console.error("[submitTalentProfileReviewAction updateProfile]", profileUpdateError);
    return {
      success: false,
      message: isArabic
  ...
  if (talentUpdateError) {
    console.error("[submitTalentProfileReviewAction updateTalent]", talentUpdateError);
    ...
    if (rollbackError) {
      console.error("[submitTalentProfileReviewAction rollbackProfile]", rollbackError);
    }
  ...
  try {
    ...
    console.error("[submitTalentProfileReviewAction event]", eventError);
  }
