...
function ApplicationCard({ item, locale, styles, compact }: { item: MobileApplicationItem; locale: "ar" | "en"; styles: ReturnType<typeof createStyles>; compact: boolean }) {
  ...
  return <View style={[styles.card, compact && styles.cardCompact, accepted && styles.cardAccepted]}>
    ...
    <View style={[styles.actionsRow, isRtl && styles.rowRtl]}>
      ...
      {accepted && item.conversationId ? <Pressable style={[styles.primaryButton, isRtl && styles.rowRtl]} onPress={() => router.push(`/conversations/${item.conversationId}`)}><MessageCircle size={15} color="#050505" strokeWidth={1.9} /><Text style={[styles.primaryButtonText, isRtl && styles.arabicText]}>{isArabic ? "فتح المحادثة" : "Open conversation"}</Text></Pressable> : null}
    </View>
  </View>;
}
...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  screen: { flex: 1, backgroundColor: theme.background }, content: { paddingHorizontal: 20, paddingTop: 10, paddingBottom: 30, gap: 12 }, contentCompact: { paddingHorizontal: 14 }, rowRtl: { flexDirection: "row-reverse" }, arabicText: { writingDirection: "rtl" }, header: { gap: 11, marginBottom: 8 }, brand: { color: theme.accent, fontSize: 12, fontWeight: "900", letterSpacing: 1.9 }, arabicBrand: { letterSpacing: 0, writingDirection: "rtl" }, title: { color: theme.text, fontSize: 29, lineHeight: 35, fontWeight: "800" }, titleCompact: { fontSize: 26, lineHeight: 31 }, subtitle: { color: theme.muted, fontSize: 13, lineHeight: 20, maxWidth: 420 }, statsRow: { flexDirection: "row", gap: 8, marginTop: 3 }, stat: { flex: 1, minHeight: 82, gap: 4, borderWidth: 1, borderColor: theme.border, borderRadius: 17, backgroundColor: theme.surface, paddingHorizontal: 12, paddingVertical: 11, justifyContent: "center" }, statCompact: { minHeight: 72, paddingHorizontal: 8, paddingVertical: 9 }, statAccent: { borderColor: "#C9A96255", backgroundColor: "#C9A96208" }, statValue: { color: theme.text, fontSize: 21, fontWeight: "800" }, statValueCompact: { fontSize: 18 }, statValueAccent: { color: theme.accent }, statLabel: { color: theme.muted, fontSize: 9 }, filterRow: { flexDirection: "row", gap: 8, marginTop: 2 }, filterTab: { flex: 1, minHeight: 42, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5, borderWidth: 1, borderColor: theme.border, borderRadius: 999, backgroundColor: theme.surface, paddingHorizontal: 8 }, filterTabCompact: { minHeight: 40, gap: 3, paddingHorizontal: 5 }, filterTabActive: { borderColor: theme.accent, backgroundColor: theme.chip }, filterText: { color: theme.muted, fontSize: 10, fontWeight: "700", flexShrink: 1 }, filterTextActive: { color: theme.accent }, filterBadge: { minWidth: 18, height: 18, borderRadius: 9, backgroundColor: theme.chip, alignItems: "center", justifyContent: "center", paddingHorizontal: 4 }, filterBadgeActive: { backgroundColor: "#C9A96222" }, filterCount: { color: theme.muted, fontSize: 8, fontWeight: "800" }, filterCountActive: { color: theme.accent }, card: { backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, borderRadius: 20, padding: 16, gap: 11 }, cardCompact: { padding: 13, gap: 9 }, cardAccepted: { borderColor: "#49C99166", backgroundColor: "#49C99108" }, cardTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, statusPill: { alignSelf: "flex-start", borderRadius: 999, borderWidth: 1, borderColor: theme.border, paddingHorizontal: 9, paddingVertical: 5 }, statusPillAccepted: { borderColor: "#49C99155", backgroundColor: "#49C99110" }, status: { color: theme.muted, fontSize: 9, fontWeight: "900" }, statusAccepted: { color: "#49C991" }, date: { color: theme.muted, fontSize: 9 }, cardTitle: { color: theme.text, fontSize: 19, lineHeight: 26, fontWeight: "800" }, cardTitleCompact: { fontSize: 17, lineHeight: 23 }, metaRow: { flexDirection: "row", gap: 10, flexWrap: "wrap", alignItems: "center" }, metaItem: { flexDirection: "row", alignItems: "center", gap: 5 }, meta: { color: theme.muted, fontSize: 10 }, typeText: { color: theme.accent, fontSize: 9, fontWeight: "800" }, acceptedBanner: { flexDirection: "row", alignItems: "center", gap: 7, borderRadius: 12, backgroundColor: "#49C9910C", paddingHorizontal: 10, paddingVertical: 8 }, acceptedHint: { color: "#49C991", fontSize: 10, fontWeight: "800", flexShrink: 1 }, actionsRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 1 }, primaryButton: { flexDirection: "row", gap: 7, backgroundColor: theme.accent, borderRadius: 12, minHeight: 44, paddingHorizontal: 14, paddingVertical: 10, alignItems: "center", justifyContent: "center" }, primaryButtonText: { color: theme.background, fontSize: 11, fontWeight: "900" }, secondaryButton: { flexDirection: "row", gap: 7, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, borderRadius: 12, minHeight: 44, paddingHorizontal: 14, paddingVertical: 10, alignItems: "center", justifyContent: "center" }, secondaryButtonText: { color: theme.text, fontSize: 11, fontWeight: "700" }, iconRtl: { transform: [{ scaleX: -1 }] }, emptyState: { minHeight: 235, borderWidth: 1, borderColor: theme.border, borderRadius: 22, backgroundColor: theme.surface, padding: 25, alignItems: "center", justifyContent: "center", gap: 10 }, emptyStateCompact: { minHeight: 205, padding: 18 }, emptyIcon: { width: 52, height: 52, borderRadius: 26, borderWidth: 1, borderColor: "#C9A96255", backgroundColor: "#C9A9620A", alignItems: "center", justifyContent: "center" }, emptyTitle: { color: theme.text, fontSize: 17, fontWeight: "800", textAlign: "center", lineHeight: 24 }, emptyBody: { color: theme.muted, fontSize: 12, lineHeight: 19, textAlign: "center", maxWidth: 300 }
}); }