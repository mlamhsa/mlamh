    ...
    <ScrollView contentContainerStyle={[styles.scrollContent, compact && styles.scrollContentCompact]} showsVerticalScrollIndicator={false}>
      <View style={[styles.content, compact && styles.contentCompact, { direction: isRtl ? "rtl" : "ltr" }]}>
        <View style={[styles.topBar, compact && styles.topBarCompact, isRtl && styles.rowReverse]}>
          ...
          <View style={styles.brandLockup}><Text style={[styles.brandArabic, compact && styles.brandArabicCompact, isArabic && styles.arabicText]}>ملامح</Text><Text style={styles.brandLatin}>M L A M H</Text><Text style={[styles.brandTagline, isArabic && styles.arabicText]}>الكاستينج والمواهب</Text></View>
          <View style={[styles.localeBadge, isRtl && styles.rowReverse]}><Globe2 size={18} color={theme.accent} strokeWidth={1.8} /><Text style={styles.localeText}>{isArabic ? "EN" : "AR"}</Text></View>
        </View>
        ...
        <View style={styles.header}>
          ...
          <Text accessibilityRole="header" style={[styles.title, compact && styles.titleCompact, isArabic && styles.arabicText, { textAlign: isRtl ? "right" : "left" }]}>{isArabic ? "ابدأ ملفك" : "Start your profile"}</Text>
...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  screen: { flex: 1, backgroundColor: theme.background }, scrollContent: { flexGrow: 1, paddingVertical: Platform.OS === "ios" ? 10 : 8 }, scrollContentCompact:{paddingVertical:4}, content: { width: "100%", maxWidth: 560, alignSelf: "center", paddingHorizontal: 22, paddingTop: 8, paddingBottom: 26, gap: 20 }, contentCompact:{paddingHorizontal:14,paddingTop:4,paddingBottom:16,gap:13}, topBar: { minHeight: 92, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 }, topBarCompact:{minHeight:68,gap:8}, rowReverse: { flexDirection: "row-reverse" }, iconButton: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center" }, brandLockup: { alignItems: "center", flex: 1 }, brandArabic: { color: theme.accent, fontSize: 42, lineHeight: 46, fontWeight: "500" }, brandArabicCompact:{fontSize:31,lineHeight:35}, brandLatin: { marginTop: -3, color: theme.accent, fontSize: 10, lineHeight: 14, fontWeight: "800", letterSpacing: 4 }, brandTagline: { color: "#B69554", fontSize: 10, lineHeight: 15, marginTop: 1 }, localeBadge: { minWidth: 52, height: 42, flexDirection: "row", alignItems: "center", justifyContent: "flex-end", gap: 7 }, localeText: { color: theme.text, fontSize: 15, fontWeight: "500" }, header: { gap: 8, marginTop: 4 }, eyebrow: { color: theme.accent, fontSize: 11, lineHeight: 16, fontWeight: "800", letterSpacing: 4 }, arabicEyebrow:{letterSpacing:0,writingDirection:"rtl"}, title: { color: theme.text, fontSize: 42, lineHeight: 48, fontWeight: "400", letterSpacing: -1.1 }, titleCompact:{fontSize:31,lineHeight:37}, subtitle: { color: theme.muted, fontSize: 15, lineHeight: 23, maxWidth: 480 }, options: { gap: 14 }, choice: { height: 236, borderRadius: 20, overflow: "hidden", borderWidth: 1, borderColor: "#FFFFFF26", backgroundColor: theme.surface }, choiceCompact:{height:204,borderRadius:18}, choiceActive: { borderColor: theme.accent, borderWidth: 1.5 }, choicePressed: { opacity: 0.9 }, choiceImage: { flex: 1 }, choiceImageRadius: { borderRadius: 19 }, choiceOverlay: { position: "absolute", top: 0, right: 0, bottom: 0, left: 0, backgroundColor: "rgba(3,3,3,0.43)" }, choiceContent: { flex: 1, padding: 18, flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "flex-start" }, choiceContentCompact:{padding:14}, choiceContentRtl: { flexDirection: "row" }, choiceCopy: { width: "54%", paddingTop: 2 }, choiceCopyCompact:{width:"64%"}, choiceTitle: { color: theme.text, fontSize: 31, lineHeight: 36, fontWeight: "400" }, choiceTitleCompact:{fontSize:25,lineHeight:30}, goldRule: { width: 34, height: 2, backgroundColor: theme.accent, marginTop: 10, marginBottom: 12 }, goldRuleRtl:{alignSelf:"flex-end"}, choiceBody: { color: "#DDD9D0", fontSize: 13, lineHeight: 18 }, bulletList: { gap: 6, marginTop: 12 }, bulletRow: { flexDirection: "row", alignItems: "center", gap: 8 }, bulletText: { color: "#E6E0D5", fontSize: 12, lineHeight: 16, flexShrink:1 }, radio: { width: 26, height: 26, borderRadius: 13, borderWidth: 1.5, borderColor: "#FFFFFF66", backgroundColor: "#05050588", alignItems: "center", justifyContent: "center" }, radioActive: { borderColor: theme.accent, backgroundColor: "#0A0A0ACC" }, radioDot: { width: 11, height: 11, borderRadius: 6, backgroundColor: theme.accent }, errorBox: { borderWidth: 1, borderColor: "#C84F4F66", backgroundColor: "#C84F4F14", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12 }, error: { color: "#E59A9A", fontSize: 13, lineHeight: 19 }, primaryButton: { backgroundColor: theme.accent, borderRadius: 14, minHeight: 60, paddingHorizontal: 22, alignItems: "center", justifyContent: "center", marginTop: 2 }, primaryButtonCompact:{minHeight:54,paddingHorizontal:16}, primaryButtonRow: { width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, primaryText: { color: theme.background, fontSize: 17, lineHeight: 22, fontWeight: "800", flex: 1, textAlign: "center" }, disabled: { opacity: 0.38 }, pressed: { opacity: 0.84 }, footerDividerRow: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 12, paddingTop: 4 }, footerLine: { width: 40, height: 1, backgroundColor: "#C9A96255" }, footnote: { color: "#7F7B73", fontSize: 9, lineHeight: 14, textAlign: "center", letterSpacing: 2.8 }, arabicFootnote:{letterSpacing:0,writingDirection:"rtl"}, arabicText: { letterSpacing: 0, writingDirection:"rtl" },
}); }
