...
function createStyles(theme: typeof lightTheme | typeof darkTheme) { return StyleSheet.create({
  ...
  statusPill: { color: theme.muted, borderWidth: 1, borderColor: theme.border, borderRadius: 14, paddingHorizontal: 10, paddingVertical: 6, fontSize: 10 }, statusApproved: { color: theme.charcoal, backgroundColor: theme.accent, borderColor: theme.accent }, metrics: { flexDirection: "row", gap: 8 }, metric: { flex: 1, padding: 13, borderWidth: 1, borderColor: theme.border, borderRadius: 18, backgroundColor: theme.surface }, metricValue: { color: theme.text, fontSize: 25, fontWeight: "800" }, metricLabel: { color: theme.muted, fontSize: 9, marginTop: 4 },
  ...
  empty: { minHeight: 220, alignItems: "center", justifyContent: "center", gap: 9, borderWidth: 1, borderStyle: "dashed", borderColor: theme.border, borderRadius: 24, padding: 22 }, emptyIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: theme.accent, alignItems: "center", justifyContent: "center" }, emptyIconText: { color: theme.charcoal, fontSize: 28 }, emptyTitle: { color: theme.text, fontSize: 18, fontWeight: "800" }, primaryButton: { marginTop: 6, backgroundColor: theme.accent, borderRadius: 15, paddingHorizontal: 18, paddingVertical: 12 }, primaryButtonText: { color: theme.charcoal, fontSize: 12, fontWeight: "900" },
  errorCard: { gap: 10, padding: 14, borderWidth: 1, borderColor: theme.border, borderRadius: 16, backgroundColor: theme.surface }, error: { color: "#C84F4F", fontSize: 13 }, retryButton: { alignSelf: "flex-start", borderWidth: 1, borderColor: theme.border, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 8 }, retryButtonText: { color: theme.text, fontSize: 11, fontWeight: "700" },
  signOut: { marginTop: 24, borderWidth: 1, borderColor: "rgba(200,79,79,0.45)", borderRadius: 17, paddingVertical: 13, alignItems: "center" }, signOutText: { color: "#C84F4F", fontSize: 13, fontWeight: "800" }
}); }
