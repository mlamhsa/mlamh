...
import { getPublisherDashboard, type MobilePublisherDashboard, type MobilePublisherOpportunity } from "@/lib/publisher-api";
...
export default function PublisherDashboardScreen() {
  ...
  const load = useCallback(async (refresh = false) => {
    ...
    setError(null);
    const result = await getPublisherDashboard(locale);
    if (!result) setError(locale === "ar" ? "تعذر تحميل لوحة الجهة." : "Unable to load publisher dashboard.");
    else setData(result);
