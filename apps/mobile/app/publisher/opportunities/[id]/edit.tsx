...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  ...
  content:{width:"100%",maxWidth:720,alignSelf:"center",paddingHorizontal:18,paddingTop:8,paddingBottom:34,gap:15}, contentCompact:{paddingHorizontal:14,gap:12}, rowRtl:{flexDirection:"row-reverse"}, textRtl:{textAlign:"right",writingDirection:"rtl"}, noTracking:{letterSpacing:0},
  ...
  hero:{gap:6,paddingVertical:4}, eyebrow:{color:theme.accent,fontSize:9,fontWeight:"900",letterSpacing:1.5}, title:{color:theme.text,fontSize:29,lineHeight:35,fontWeight:"800"}, titleCompact:{fontSize:25,lineHeight:31}, body:{color:theme.muted,fontSize:12,lineHeight:19},
