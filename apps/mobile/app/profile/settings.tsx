...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  screen:{flex:1,backgroundColor:theme.background},content:{width:"100%",maxWidth:680,alignSelf:"center",paddingHorizontal:20,paddingTop:20,paddingBottom:42,gap:18},contentCompact:{paddingHorizontal:14,paddingTop:14,gap:14},top:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",minHeight:54},rowRtl:{flexDirection:"row-reverse"},textRtl:{textAlign:"right",writingDirection:"rtl"},arabicText:{writingDirection:"rtl",letterSpacing:0},backButton:{width:44,height:44,borderRadius:22,borderWidth:1,borderColor:theme.border,backgroundColor:theme.surface,alignItems:"center",justifyContent:"center"},brand:{color:theme.accent,fontSize:15,fontWeight:"900",letterSpacing:1.7},brandArabic:{letterSpacing:0},hero:{flexDirection:"row",alignItems:"center",gap:12,borderWidth:1,borderColor:"#C9A96233",borderRadius:22,backgroundColor:"#C9A96208",padding:16},heroCompact:{padding:13},heroIcon:{width:46,height:46,borderRadius:15,borderWidth:1,borderColor:"#C9A96244",backgroundColor:"#C9A9620C",alignItems:"center",justifyContent:"center"},heroCopy:{flex:1},title:{color:theme.text,fontSize:27,lineHeight:33,fontWeight:"800"},titleCompact:{fontSize:24,lineHeight:29},subtitle:{color:theme.muted,fontSize:12,lineHeight:18,marginTop:3},sectionLabel:{color:theme.muted,fontSize:9,fontWeight:"900",letterSpacing:1.5,marginTop:4},sectionLabelArabic:{letterSpacing:0,fontSize:11},card:{borderWidth:1,borderColor:theme.border,borderRadius:20,padding:15,gap:13,backgroundColor:theme.surface},cardCompact:{padding:12,gap:11},cardHeading:{flexDirection:"row",alignItems:"center",gap:12},cardHeadingCopy:{flex:1},iconShell:{width:42,height:42,borderRadius:14,alignItems:"center",justifyContent:"center",backgroundColor:"#C9A9620B",borderWidth:1,borderColor:"#C9A96233"},languageOptions:{flexDirection:"row",gap:9},languageOption:{flex:1,minHeight:46,borderWidth:1,borderColor:theme.border,borderRadius:14,alignItems:"center",justifyContent:"center"},languageOptionActive:{borderColor:theme.accent,backgroundColor:"#C9A96218"},languageOptionText:{color:theme.muted,fontSize:13,fontWeight:"800"},languageOptionTextActive:{color:theme.accent},switchingRow:{flexDirection:"row",alignItems:"center",gap:8},switchingText:{color:theme.muted,fontSize:11},pushHeader:{flexDirection:"row",alignItems:"center",gap:12},pushCopy:{flex:1},statusDot:{width:9,height:9,borderRadius:5,backgroundColor:theme.grayMuted},statusDotEnabled:{backgroundColor:theme.accent},pushButton:{minHeight:48,borderRadius:14,backgroundColor:theme.accent,alignItems:"center",justifyContent:"center",paddingHorizontal:10},pushButtonDisabled:{opacity:.55},pushButtonText:{color:theme.background,fontSize:13,fontWeight:"900",textAlign:"center"},pushMessage:{color:theme.muted,fontSize:10,lineHeight:16},group:{borderWidth:1,borderColor:theme.border,borderRadius:20,overflow:"hidden",backgroundColor:theme.surface},row:{minHeight:72,paddingHorizontal:14,paddingVertical:12,flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:12,borderBottomWidth:1,borderBottomColor:theme.border},rowCompact:{minHeight:64,paddingHorizontal:11,paddingVertical:10},rowLast:{borderBottomWidth:0},rowLead:{flex:1,flexDirection:"row",alignItems:"center",gap:12},rowText:{flex:1},rowTitle:{color:theme.text,fontSize:14,fontWeight:"800"},rowSubtitle:{color:theme.muted,fontSize:11,lineHeight:17,marginTop:3},signOut:{minHeight:54,borderRadius:16,borderWidth:1,borderColor:"#C84F4F66",alignItems:"center",justifyContent:"center",flexDirection:"row",gap:9,marginTop:2},signOutText:{color:"#E59A9A",fontSize:14,fontWeight:"900"},disabled:{opacity:.5}
}); }
