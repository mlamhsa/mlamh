  ...
  return <SafeAreaView style={styles.screen} edges={["top"]}>
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      <View style={[styles.top, isRtl && styles.rowRtl]}>
        ...
        <Text style={[styles.brand, isArabic && styles.brandArabic, isRtl && styles.textRtl]}>{isArabic ? "ملامح" : "MLAMH"}</Text>
      </View>
      ...
      <View style={styles.group}><SettingsRow title={isArabic ? "المساعدة والدعم" : "Help & support"} subtitle={isArabic ? "الشكاوى، الدعم وطرق التواصل" : "Complaints, support and contact"} icon={LifeBuoy} onPress={() => router.push("/support")} isRtl={isRtl} ForwardIcon={ForwardIcon} styles={styles} theme={theme} last/></View>

      <Text style={sectionLabelStyle}>{isArabic ? "القانوني" : "LEGAL"}</Text>
      <View style={styles.group}><SettingsRow title={isArabic ? "القانوني والسياسات" : "Legal & policies"} subtitle={isArabic ? "الخصوصية، الشروط وسياسة الاسترداد" : "Privacy, terms and refund policy"} icon={Scale} onPress={() => router.push("/support")} isRtl={isRtl} ForwardIcon={ForwardIcon} styles={styles} theme={theme} last/></View>
