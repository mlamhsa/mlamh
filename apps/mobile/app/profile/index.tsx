...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  ...
  readinessCard: { gap: 11, padding: 16, borderWidth: 1, borderColor: theme.border, borderRadius: 16, backgroundColor: theme.surface }, progressTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, progressValue: { color: theme.accent, fontSize: 21, fontWeight: "900" }, progressTrack: { height: 5, borderRadius: 3, overflow: "hidden", backgroundColor: theme.border }, progressFill: { height: 5, backgroundColor: theme.accent }, taskRow: { minHeight: 38, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 9, borderTopWidth: 1, borderTopColor: theme.border, paddingTop: 9 }, taskText: { flex: 1, color: theme.text, fontSize: 11 }, taskArrow: { color: theme.accent, fontSize: 18 }, reviewLink: { minHeight: 42, alignItems: "center", justifyContent: "center", borderRadius: 11, borderWidth: 1, borderColor: theme.accent }, reviewLinkText: { color: theme.accent, fontSize: 11, fontWeight: "800" },
