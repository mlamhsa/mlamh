...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  screen:{flex:1,backgroundColor:theme.background},content:{width:"100%",maxWidth:720,alignSelf:"center",paddingHorizontal:20,paddingTop:14,paddingBottom:40,gap:16},topBar:{flexDirection:"row",justifyContent:"space-between",alignItems:"center"},headerActions:{flexDirection:"row",gap:10},iconButton:{width:46,height:46,borderRadius:23,borderWidth:1,borderColor:theme.border,alignItems:"center",justifyContent:"center",position:"relative"},iconGlyph:{fontSize:19,color:theme.text},badge:{position:"absolute",right:-3,top:-3,minWidth:18,height:18,borderRadius:9,backgroundColor:theme.accent,alignItems:"center",justifyContent:"center",paddingHorizontal:4},badgeText:{fontSize:9,fontWeight:"900",color:theme.background},eyebrow:{color:theme.accent,fontSize:12,fontWeight:"900",letterSpacing:2},pageTitle:{color:theme.text,fontSize:30,lineHeight:36,fontWeight:"900"},errorCard:{borderWidth:1,borderColor:theme.border,borderRadius:18,padding:24,alignItems:"center",gap:16},errorText:{color:theme.text,fontSize:16,textAlign:"center"},retryButton:{backgroundColor:theme.accent,borderRadius:12,paddingHorizontal:24,paddingVertical:14},retryText:{color:theme.background,fontWeight:"900"},identitySection:{alignItems:"center",gap:7,borderWidth:1,borderColor:theme.border,borderRadius:24,paddingHorizontal:18,paddingTop:20,paddingBottom:18,backgroundColor:theme.surface},avatarWrap:{width:112,height:112,borderRadius:56,position:"relative"},avatar:{width:112,height:112,borderRadius:56},avatarPlaceholder:{width:112,height:112,borderRadius:56,borderWidth:1,borderColor:theme.border,alignItems:"center",justifyContent:"center",backgroundColor:theme.chip},avatarInitial:{fontSize:46,color:theme.accent,fontWeight:"500"},photoEdit:{position:"absolute",right:2,bottom:4,width:34,height:34,borderRadius:17,backgroundColor:theme.accent,alignItems:"center",justifyContent:"center",borderWidth:3,borderColor:theme.background},photoEditText:{color:theme.background,fontSize:20,fontWeight:"900"},name:{color:theme.text,fontSize:26,fontWeight:"900"},category:{color:theme.accent,fontSize:14,fontWeight:"800"},location:{color:theme.muted,fontSize:13},statsRow:{width:"100%",flexDirection:"row",gap:8,marginTop:10},stat:{flex:1,alignItems:"center",paddingVertical:11,borderRadius:14,backgroundColor:theme.chip},statValue:{color:theme.text,fontSize:20,fontWeight:"900"},statLabel:{color:theme.muted,fontSize:10,marginTop:2},primaryButton:{width:"100%",backgroundColor:theme.accent,borderRadius:14,minHeight:54,alignItems:"center",justifyContent:"center",marginTop:4},primaryButtonText:{color:theme.background,fontWeight:"900",fontSize:16},statusStrip:{flexDirection:"row",gap:8},statusItem:{flex:1,borderWidth:1,borderColor:theme.border,borderRadius:14,paddingHorizontal:10,paddingVertical:11,backgroundColor:theme.surface},statusLabel:{color:theme.muted,fontSize:11},statusValue:{color:theme.text,fontSize:14,fontWeight:"800",marginTop:5},readinessCard:{borderWidth:1,borderColor:theme.border,borderRadius:22,padding:16,gap:12,backgroundColor:theme.surface},progressTop:{flexDirection:"row",justifyContent:"space-between",alignItems:"flex-start"},progressValue:{color:theme.accent,fontSize:28,fontWeight:"900"},progressTrack:{height:7,borderRadius:4,backgroundColor:theme.border,overflow:"hidden"},progressFill:{height:"100%",backgroundColor:theme.accent},sectionEyebrow:{color:theme.accent,fontSize:10,fontWeight:"900",letterSpacing:2},sectionTitle:{color:theme.text,fontSize:22,fontWeight:"900",marginTop:4},taskRow:{minHeight:50,borderTopWidth:1,borderColor:theme.border,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},taskText:{color:theme.text,fontSize:14},taskArrow:{color:theme.accent,fontSize:24},reviewLink:{minHeight:52,borderRadius:13,borderWidth:1,borderColor:theme.accent,alignItems:"center",justifyContent:"center"},reviewLinkText:{color:theme.accent,fontWeight:"900"},section:{gap:12},sectionHeader:{flexDirection:"row",justifyContent:"space-between",alignItems:"flex-end"},inlineAction:{color:theme.accent,fontWeight:"900"},galleryRow:{gap:10},galleryImage:{width:116,height:150,borderRadius:14,backgroundColor:theme.surface},emptyMedia:{minHeight:130,borderWidth:1,borderStyle:"dashed",borderColor:theme.border,borderRadius:16,alignItems:"center",justifyContent:"center"},emptyMediaText:{color:theme.muted,fontSize:14}
});}
