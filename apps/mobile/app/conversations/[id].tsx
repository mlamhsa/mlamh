...
function createStyles(theme: typeof lightTheme | typeof darkTheme) {
  return StyleSheet.create({
    ...
    backIcon: { color: theme.text, fontSize: 31, lineHeight: 34 },
    headerIdentity: { flex: 1, flexDirection: "row", alignItems: "center", gap: 10 },
    avatar: { width: 42, height: 42, borderRadius: 21, borderWidth: 1, borderColor: theme.accent, backgroundColor: theme.surface, alignItems: "center", justifyContent: "center" },
    avatarText: { color: theme.accent, fontSize: 18, fontWeight: "800" },
    headerText: { flex: 1, gap: 2 },
    partyName: { color: theme.text, fontSize: 16, fontWeight: "800" },
    statusRow: { flexDirection: "row", alignItems: "center", gap: 5 },
    liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: theme.accent },
    offlineDot: { backgroundColor: theme.muted },
    liveText: { color: theme.muted, fontSize: 10, fontWeight: "600" },
    opportunity: { width: "100%", color: theme.muted, fontSize: 11, paddingHorizontal: 52 },
    messages: { paddingHorizontal: 16, paddingTop: 18, paddingBottom: 16, gap: 9, flexGrow: 1, justifyContent: "flex-end" },
    bubble: { maxWidth: "80%", borderRadius: 18, paddingHorizontal: 14, paddingVertical: 10 },
    mine: { alignSelf: "flex-end", backgroundColor: theme.accent, borderBottomRightRadius: 6 },
    theirs: { alignSelf: "flex-start", backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, borderBottomLeftRadius: 6 },
    messageText: { color: theme.text, fontSize: 15, lineHeight: 21 },
    mineText: { color: theme.charcoal, fontWeight: "600" },
    empty: { color: theme.muted, textAlign: "center", paddingVertical: 50 },
    composer: { borderTopWidth: 1, borderTopColor: theme.border, paddingHorizontal: 12, paddingTop: 9, paddingBottom: 20, gap: 6, backgroundColor: theme.background },
    composerRow: { flexDirection: "row", alignItems: "flex-end", gap: 8 },
    input: { flex: 1, maxHeight: 120, minHeight: 46, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, color: theme.text, borderRadius: 23, paddingHorizontal: 15, paddingVertical: 11, fontSize: 15 },
    sendButton: { width: 46, height: 46, borderRadius: 23, backgroundColor: theme.accent, alignItems: "center", justifyContent: "center" },
    sendDisabled: { opacity: 0.42 },
    sendText: { color: theme.charcoal, fontWeight: "900", fontSize: 15 },
    ...
    back: { color: theme.accent, fontSize: 13, fontWeight: "700" },
  });
}