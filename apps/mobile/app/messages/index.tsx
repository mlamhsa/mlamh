...
function createStyles(theme: typeof darkTheme) { return StyleSheet.create({
  ...
  header: { gap: 9, marginBottom: 18 }, brand: { color: theme.accent, fontSize: 12, fontWeight: "900", letterSpacing: 1.8 }, titleRow: { flexDirection: "row", alignItems: "center", gap: 9 }, title: { color: theme.text, fontSize: 28, lineHeight: 34, fontWeight: "800" }, subtitle: { color: theme.muted, fontSize: 13, lineHeight: 20, maxWidth: 430 }, unreadPill: { minWidth: 24, height: 24, borderRadius: 12, backgroundColor: theme.accent, paddingHorizontal: 7, alignItems: "center", justifyContent: "center" }, unreadPillText: { color: theme.background, fontSize: 10, fontWeight: "900" },
  row: { minHeight: 86, flexDirection: "row", alignItems: "center", gap: 12, borderWidth: 1, borderColor: theme.border, borderRadius: 17, backgroundColor: theme.surface, paddingHorizontal: 12, paddingVertical: 12, marginBottom: 8 }, rowRtl: { flexDirection: "row-reverse" }, pressed: { opacity: 0.68 }, avatar: { width: 50, height: 50, borderRadius: 25, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface }, avatarFallback: { alignItems: "center", justifyContent: "center" }, avatarUnread: { borderColor: theme.accent }, avatarInitial: { color: theme.accent, fontSize: 18, fontWeight: "800" },
