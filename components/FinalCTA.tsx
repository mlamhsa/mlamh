      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="overflow-hidden rounded-[2.5rem] border border-gold/15 bg-gradient-to-b from-white/[0.05] to-white/[0.02] p-10 md:p-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-8 text-4xl font-light leading-tight tracking-normal text-white md:text-6xl">
              {isAr
                ? "ابدأ رحلتك الإبداعية اليوم."
                : "Start Your Creative Journey Today."}
            </h2>

            <p className="mt-6 text-lg leading-8 tracking-normal text-white/55">
              {isAr
          ...
          <div className="mt-14 grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-medium tracking-normal">
            ...
            >
              ...
              <h3 className="mt-5 text-lg font-light tracking-normal text-white">
