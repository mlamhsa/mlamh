...
export default function TalentApprovedCompletionBanner({
  ...
  return (
    <div
      ...
      className="w-full px-4 pt-28 sm:px-6 lg:pt-32"
    >
      <div className="mx-auto w-full max-w-7xl">
        <div className="flex flex-col gap-6 xl:flex-row">
          <div className="hidden xl:block xl:w-80 xl:flex-shrink-0" aria-hidden="true" />
          <div className="min-w-0 flex-1">
            <div className="w-full rounded-[1.75rem] border border-emerald-400/20 bg-emerald-400/[0.045] p-5 sm:flex sm:items-center sm:justify-between sm:gap-5 sm:p-6">
              <div className="flex min-w-0 gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm leading-7 text-white/55">
                    {isArabic
                      ? `ملفك معتمد ولن تحتاج لإعادة المراجعة. قوة ملفك الآن ${profileStrength}% — أكمل بياناتك المهنية لزيادة فرص ظهورك للجهات وتحسين المطابقة مع الفرص.`
                      : `Your profile remains approved and does not need another review. Profile strength is ${profileStrength}% — add professional details to improve discovery and matching.`}
                  </p>
                </div>
              </div>
              <Link
                href={`${root}/profile/details`}
