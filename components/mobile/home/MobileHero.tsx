...
<div className="relative z-10 mt-4 grid grid-cols-2 gap-3">
  ...
  <Link
    ...
    className="flex min-h-[72px] items-center justify-center rounded-[1.35rem] border px-5 text-[15px] font-semibold text-[#090909] transition active:scale-[0.985]"
  >
    {isArabic ? "انضم كموهبة" : "Join as Talent"}
  </Link>
  ...
  <Link
    ...
    className="flex min-h-[72px] items-center justify-center rounded-[1.35rem] border px-5 text-[15px] font-medium text-white/80 backdrop-blur-xl transition active:scale-[0.985]"
  >
    {isArabic ? "أنا جهة" : "I'm an Organization"}
  </Link>
</div>

        {/* Talent visual discovery */}
<div className="relative z-10 mt-4 grid h-[285px] grid-cols-[1.15fr_0.85fr] gap-3">
        ...
        <div className="relative z-10 mt-4 flex items-center justify-between gap-4 border-t border-white/[0.07] pt-4 text-[11px] text-white/35">
          ...
          <span className="font-medium tracking-[0.12em] text-gold/70">
            MLAMH
          </span>
        </div>
      </div>
